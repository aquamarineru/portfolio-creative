  ...
  return (
    <div id='main'>
        <div className='w-full h-screen flex flex-col justify-center items-center absolute top-0 left-0 bg-[#E8EDDF] lg:items-end dark:bg-[#0D060F]'>
            ...
            <div className='container m-auto px-4 max-w-[320px] h-full w-full flex flex-col justify-end items-center bg-[url("src/img/main-light.png")] bg-no-repeat bg-top bg-contain bg-[length:320px] md:max-w-[500px] lg:max-w-[900px] lg:bg-[length:420px] lg:bg-right xl:max-w-[1200px] xl:bg-[length:530px] dark:bg-[url("src/img/main-dark.png")] dark'>
        ...
        <div className='invisible md:visible'>
            ...
            <GrReactjs size={50} className='absolute text-gray-500 top-[60%] left-[75%] hover:animate-spin lg:left-[30%] lg:top-[80%] dark:text-white/80'/>
